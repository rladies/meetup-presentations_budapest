...
## A tidyverse csomagokra valószínuleg szükségetek lesz.
library(tidyverse)
...
## Ok mennyit idot töltenek otthon tanulással?
## 3 pont
#################################################################################
...
## az otthoni gyakorlást jelzo változókat (OraszamOtthon*)!
## 2 pont
#################################################################################
...
#################################################################################
## 3.2. feladat: Rajzoljunk boxplotot a szövegértés pontszámokból a nemekre
